...
**Documentation (German)**  | https://docs.goobi.io/de/workflow/plugins/step/goobi-plugin-step-metadata-update-field
**Documentation (English)** | https://docs.goobi.io/en/workflow/plugins/step/goobi-plugin-step-metadata-update-field
